...
const envSchema = z.object({
  ...
  STRIPE_PRICE_PERSONAL_BRL_CENTS: z.coerce.number().int().positive().default(1990),
  STRIPE_PRICE_BUSINESS_BRL_CENTS: z.coerce.number().int().positive().default(3990),
  STRIPE_PRICE_PREMIUM_BRL_CENTS: z.coerce.number().int().positive().default(4990),
